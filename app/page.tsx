            ...
            <div className="grid lg:grid-cols-12 gap-12">
              <div className="lg:col-span-5">
                ...
                <div className="space-y-6 prg-reveal reveal-delay-3">
                  {[
                    { icon: '\u{1F4CD}', label: 'Office', value: '233 S. Wacker Drive, Suite 4200\nChicago, IL 60606', href: 'https://maps.google.com/?q=233+S+Wacker+Drive+Suite+4200+Chicago+IL+60606' },
                    { icon: '\u{1F4DE}', label: 'Phone', value: '(312) 555-0187', href: 'tel:+13125550187' },
                    { icon: '\u2709', label: 'Email', value: 'info@whitfieldcpa.com', href: 'mailto:info@whitfieldcpa.com' },
                  ].map((item, i) => (
        ...
        <section className="py-20 md:py-28 bg-[color:var(--navy)] text-center relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
            ...
            <div className="flex gap-4 justify-center flex-wrap prg-reveal reveal-delay-3">
              <a href="mailto:info@whitfieldcpa.com" className="btn-gold">
                Get Free Quote <ArrowRight />
              </a>
              <a href="tel:+13125550187" className="btn-luxury-outline border-white/30 text-white hover:bg-white hover:text-navy">
                Schedule a Call
              </a>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6 text-sm">
              ...
              <a href="tel:+13125550187" className="footer-link">(312) 555-0187</a>
              <a href="mailto:info@whitfieldcpa.com" className="footer-link">info@whitfieldcpa.com</a>
            </div>
          </div>
          <div className="flex justify-center gap-6 mt-8">
            <a href="https://www.linkedin.com/company/whitfield-associates" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="footer-link p-2 min-h-[44px] min-w-[44px] flex items-center justify-center">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
            <a href="https://www.facebook.com/whitfieldassociates" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer-link p-2 min-h-[44px] min-w-[44px] flex items-center justify-center">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
